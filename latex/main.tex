...
\renewcommand*{\ticketdefault}{%
  \put(10,14){\lbox{\includegraphics[width=1in]{uchicago-logo}}}%
  \put(380,14){\rbox{\includegraphics[width=0.7in]{kicp-logo}}}%
  \put(10,48){\lbox{\includegraphics[width=1in]{desc-logo}}}%
  \put(380,60){\rbox{\includegraphics[width=0.7in]{lsstc-logo}}}%
  \put(205,29){\cbox{\latinfont\scriptsize  Collaboration Meeting, Aug.~1--5, 2022}}% Update dates as needed
  \put(205,15){\cbox{\latinfont\scriptsize University of Chicago}}% Update location as needed
}
